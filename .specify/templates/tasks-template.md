...
**Tests and Harness**: Test and harness tasks are REQUIRED. Every user story MUST include harness coverage and executable validation before implementation is considered complete.
...
- [ ] T004 Establish harness scaffolding for scenario execution and CI integration
...
- [ ] T011 [P] Add observability baseline (structured logs, metrics, traces)
- [ ] T012 [P] Add UI baseline checks for responsive behavior and dark/light mode support
- [ ] T013 [P] Define Azure Well-Architected review checklist and minimal-cost budget guardrails
...
- [ ] T016 [US1] Harness scenario for primary journey and edge case in tests/harness/[name].py
...
- [ ] T025 [US2] Harness scenario for recommendation and exception path in tests/harness/[name].py
...
- [ ] T032 [US3] Harness scenario for approval/alert flow in tests/harness/[name].py
...
- [ ] TXXX [P] Validate dashboard responsiveness and dark/light mode behavior
- [ ] TXXX [P] Validate alerting, metrics, and trace dashboards
